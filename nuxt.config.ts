...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      DOWNLOAD_MACOS_URL: 'https://apps.apple.com/de/app/chronos-for-jira/id6749211630?mt=12',
  ...
  routeRules: {
    '/**': process.env.ENV === 'development' ? { cache: false } : { isr: 60 * 60 * 24 }, // Cache for 1 day in production
    '/api/**': { cache: false },
  },
